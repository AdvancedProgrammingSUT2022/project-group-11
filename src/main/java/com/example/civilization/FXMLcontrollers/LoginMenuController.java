...
public class LoginMenuController {
    private DatabaseController databaseController = Main.databaseController;
    @FXML
    ...
    public void login ()
    {
        ...
        if ( user != null)
        {
            Main.database.setActiveUser(user);
            ProfileMenuController.databaseController = Main.databaseController;
